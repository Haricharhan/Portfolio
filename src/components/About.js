        ...
        <div className="mx-auto flex lg:flex-row flex-col items-center justify-center">
          ...
          >
            <img
              ...
              alt="hero"
              src={require("../assets/Images/Pics/story.png")}
            />
          </div>
          <div className="lg:w-1/2 justify-center lg:p-5 xl:p-7 md:p-5 flex flex-col items-center text-justify">
            ...
            >
              A passionate and dedicated web developer currently in my 4th year of B.Tech, with a strong
               background in creating visually stunning and highly functional websites. Throughout my 
               academic journey, I have developed proficiency in various web technologies including HTML5,
                CSS3, and JavaScript. I am well-versed in popular libraries such as React and frameworks like Next.js and Tailwind CSS,
                 allowing me to build robust and responsive websites.
              I'm excited to take on new challenges and 
              contribute to innovative projects. Feel free to connect with me through my social media links.
            </p>
            <div
              data-aos="zoom-in"
